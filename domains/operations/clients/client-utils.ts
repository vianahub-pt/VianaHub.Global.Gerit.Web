...
export function normalizeClient(payload: unknown): ClientItem | null {
  ...
  return {
    ...
    phone,
    isActive,
    partyTypeId: (clientType != null ? getPartyTypeFromClientType(clientType) : undefined) ?? (1 as PartyType),
    ...
    urlImage,
    note,
    clientType: (typeof clientType === "number" ? clientType : undefined) as ClientType | undefined,
    individual,
    company,
  };
}
