...
>(
  (
    ...
    // Use context collapsible as fallback, but allow prop override
    const effectiveCollapsible = collapsible !== "offcanvas" ? collapsible : contextCollapsible
      ...
      return (
        <div
          className={cn(
            ...
            isFloating ? "w-max" : "w-[--sidebar-width]",
            className
          )}
          ref={ref}
...
>(({ className, ...props }, ref) => {
  ...
  const isNoneCollapsible = collapsible === "none"
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={cn(
        ...
        isNoneCollapsible ? "w-auto" : "w-full",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn("text-sm", isNoneCollapsible ? "w-auto" : "w-full", className)}
      {...props}
    />
  )
})
